...
class Battle{
    ...
    public:
        Battle(string nome, int atk, int def, int lvl, int lf);
        ...
        void set_lf(int lf); //Essa função irá definir o life da nave
...
Battle::Battle(string nome, int atk, int def, int lvl, int lf){
    objNome = nome;
    objAtaque = atk;
    objDefesa = def;
    objLevel = lvl;
